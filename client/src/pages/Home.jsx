...
const Home = () => {
  ...
  const offerfetch=async()=>{
    ...
    const resp =await fetch(`https://majestic-acres.onrender.com/api/v1/listing/get?offer=true&limit=3`,{method:'GET',headers:{'Content-Type': 'application/json' }, credentials: 'include' })
  ...
  const salefetch=async()=>{
    ...
    const resp =await fetch(`https://majestic-acres.onrender.com/api/v1/listing/get?type=sale&limit=3`,{method:'GET',headers:{'Content-Type': 'application/json' }, credentials: 'include' })
    const data=await resp.json()
  ...
  const rentfetch=async()=>{
    ...
    const resp =await fetch(`https://majestic-acres.onrender.com/api/v1/listing/get?type=rent&limit=3`,{method:'GET',headers:{'Content-Type': 'application/json' }, credentials: 'include' })
    const data=await resp.json()
