...
const fetchlist=async()=>{
    const resp=await fetch('https://majestic-acres.onrender.com/api/v1/listing/get/'+params.listing,{method:'GET',headers:{Authorization:localStorage.getItem("token"),    'Content-Type': 'application/json', 
    }})
